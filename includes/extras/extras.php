...
function editorx_public_scripts(){
	...
	$editorx_primary_color			= get_theme_mod( 'editorx_website_primary_color', '#000000' );
	...
	wp_enqueue_style( 'editorx-google-fonts', editorx_google_fonts_url(), array(), EDITORX_THEME_VERSION );
