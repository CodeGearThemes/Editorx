	...
	$(function() {
		...
		$('.google-fonts-list').on('change', function() {
			...
			$.each(bodyfontcontrol.fontslist[index].variants, function(val, text) {
				...
				if ( $(elementMediumWeight).find( 'option[value="600"]').length > 0 ) {
					$( elementMediumWeight ).val( '600' );
				} else if ( $(elementMediumWeight).find( 'option[value="500"]').length > 0 ) {
					$( elementMediumWeight ).val( '500' );
				} else if ( $(elementMediumWeight).find( 'option[value="700"]').length > 0 ) {
					$( elementMediumWeight ).val( '700' );
				}
		...
		$('.customize-control-editorx-tabs-control').each(function () {
			$(this).parent().find('li').not('.section-meta').not('.customize-control-editorx-tabs-control').addClass('hide-control');
			...
			$(this).find('.control-tab').on('click', function () {
				...
				$(this).parent().parent().parent().find('li').not('.section-meta').not('.customize-control-editorx-tabs-control').addClass('hide-control');
